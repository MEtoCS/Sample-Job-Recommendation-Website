...
////		//////////////////////////////////////////////////////////////////////////////
////		response.setContentType("application/json"); // response header, data format
////		
////		PrintWriter writer = response.getWriter(); //response body 中写东西
////		JSONObject obj = new JSONObject();
////		obj.put("username", "abcd");
////		writer.print(obj);//print response 对应的 writer
////		//////////////////////////////////////////////////
...
//	}
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		for (Item item : items) {
			// JSONObject obj = item.toJSONObject();
			org.json.JSONObject obj = item.toJSONObject();// ???????
			obj.put("favorite", favoritedItemIds.contains(item.getItemId()));
			array.put(obj);
		}
		RpcHelper.writeJsonArray(response, array);
