...
//	private static final String API_Key="d786c4b80e46b94f23df0ad51e81e6ca0f333579";
//	
...
//	//<"hello", "world">
//	
//	private static List<List<Sring>> getKeywords(JAONArray mlResultArray){
//		List<List<String>> topkeywords = new ArrayList<>();
//		
//		for(int i=0; i< mlResultArray.size() ; i++) {
//			List<String> keywords = new ArrayList<>();
//			JASONArray keywordArray = (JASONArray) mlResultArray.get(i);
//			
//			for(int j=0; j < keywordArray.size() ; j++) {
//				JASONArray keywordobject = (JSONobject)keywordsArray.get(j);
...
public class MonkeyLearnClient {
	private static final String API_KEY = "d786c4b80e46b94f23df0ad51e81e6ca0f333579";// make sure change it to your api key.
